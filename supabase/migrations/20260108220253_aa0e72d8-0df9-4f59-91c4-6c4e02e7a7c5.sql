-- Drop the old UUID[] version to avoid confusion
DROP FUNCTION IF EXISTS public.get_report_data(DATE, DATE, UUID[], UUID[], UUID[]);

-- Replace the TEXT[] version with corrected JOIN logic and client_tax_rate
